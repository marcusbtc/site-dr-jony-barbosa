        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left mb-12">
            {[
              ...
              {
                title: "Tecnologia",
                desc: "Uso de recursos diagnósticos e técnicas atuais em cirurgia ginecológica e exames.",
              ...
              {
                title: "Atualização",
                desc: "Acompanhamento contínuo de práticas clínicas e recursos diagnósticos aplicáveis à rotina de cuidado.",
